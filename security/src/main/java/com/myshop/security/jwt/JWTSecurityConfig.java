...
public class JWTSecurityConfig {
    ...
    public SecurityWebFilterChain configure(ServerHttpSecurity http, ReactiveAuthenticationManager authenticationManager) throws Exception {
        return http
                ...
                .pathMatchers("/api/auth/**","/api/notify/**","/api/payment/**","/api/shipment/**","/api/chatbot/**", "/api/address/**" ,"/api/common/**", "/swagger-ui.html", "/webjars/**", "/api-docs/**", "/uploads/**", "/api/upload/**").permitAll()
